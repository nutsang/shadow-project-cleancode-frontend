...
const TopUp = () => {
    ...
    return (
        <div>
            ...
            <img alt="topup" src="http://localhost:3001/public/images/topup/topup.jpg" className='h-96 mx-auto container rounded' />
            ...
            <div className='flex flex-col items-center justify-center mx-60 mt-10'>
            ...
            <dialog id='image-payment-method' className='modal'>
                <div className='modal-box'>
                    ...
                    <img src={`http://localhost:3001/public/images/payment-method/payment-method.png`} alt='image-payment-method' className='size-full h-96' />
